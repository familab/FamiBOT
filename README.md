...
FamiBOT is a chat bot built on the [Hubot][hubot] framework. It was
...
You can start FamiBOT locally by running:
...
Then you can interact with FamiBOT by typing `FamiBOT help`.

    FamiBOT> FamiBOT help
